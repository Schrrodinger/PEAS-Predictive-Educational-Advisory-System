...
const Page4 = () => {
    ...
    return (
        <div className="InterestPage large-12 small-12 medium-12 columns" style={{boxSizing: 'border-box', marginLeft: 0, marginTop: 0, width: '100%',height:'auto', position: 'relative', overflowY: 'scroll' }}>
            ...
            <div className="InterestContainer large-12 medium-12 small-12 columns" style={{ boxSizing: 'border-box', position: 'relative', width: '100%', height: '70vh' }}>
                <form className="InterestForm large-12 medium-12 small-12 columns" style={{ width: 'inherit', height: 'inherit', position: 'relative' }}>
                    <fieldset className="InterestList large-12 medium-12 small-12 columns" style={{ border: '2px solid lightgoldenrodyellow', position: 'relative', height: "-webkit-fit-content", width: '100%' }}>
