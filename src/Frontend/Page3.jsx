...
const Page4 = () => {
    ...
    const getChoiceDetails = (choice) => {
        const details = {
            ...
            'G': 'Nấu ăn; Khám phá ẩm thực.',
            'H': 'Du lịch và tìm hiểu văn hóa, lịch sử của các khu vực khác nhau.',
            'I': 'Làm đồ thủ công; Chế tạo đồ dùng; Thiết kế thời trang.',
    ...
    return (
        <div className="InterestPage large-12 small-12 medium-12 columns" style={{ boxSizing: 'border-box', marginLeft: 0, marginTop: 0, width: '100%', height: '100%', position: 'relative', overflowY: 'scroll' }}>
            ...
            <div className="InterestContainer large-12 medium-12 small-12 columns" style={{ boxSizing: 'border-box', position: 'relative', width: '100%', height: 'max-content' }}>
                <form className="InterestForm large-12 medium-12 small-12 columns" style={{ width: 'inherit', height: 'inherit', position: 'relative' }}>
                    <fieldset className="InterestList large-12 medium-12 small-12 columns" style={{ border: '2px solid lightgoldenrodyellow', position: 'relative', height: 'max-content', width: '100%' }}>
                        ...
                        {['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J'].map(choice => (
                            <label key={choice} className={`Choice ${choice} large-12 medium-12 small-12 columns`} style={{ alignContent: 'center', alignSelf: 'center' }}>
                                ...
                                <div className="details" style={{ visibility: openDropdowns[choice] ? 'visible' : 'hidden' }}>
