...
function Page5() {
    return (
        <div className="RatingPage" style={{ border: '4px solid lightblue', boxSizing: 'border-box', position: 'absolute', width: '100%', height: '100%', overflow: 'scroll' }}>
            <div className="Panigation large-12 medium-12 small-12 columns" style={{ border: '3px solid lawngreen', boxSizing: 'border-box', position: 'relative', width: '100%', height: 'fit-content', margin: 'auto', display: 'flex', justifyContent: 'space-between', alignSelf: 'center', alignItems: 'center' }}>
            ...
            <div className="GradingContainer large-12 medium-12 small-12 columns" style={{ boxSizing: 'border-box', border: '5px solid lightpink', position: 'relative', width: '100%', height: '100%' }}>
                <div className="Textbox1 large-12 medium-12 small-12 columns" style={{ border: '3px solid lightgreen', boxSizing: 'border-box', width: 'max(107%)', height: 'fit-content', position: 'relative' }}>
                ...
                <form className="GradingSlideContainer large-12 medium-12 small-12 columns" style={{ position: 'relative', height: 'max-content', boxSizing: 'border-box', border: '5px solid lightskyblue' }}>
                    {/* Skill 1 */}
                    <div className="Skill1 large-12 medium-12 small-12 columns" id="Skill_1" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', boxSizing: 'border-box', border: '3px solid red', width: 'inherit', height: 'max-content' }}>
                    ...
                    {/* Skill 2 */}
                    <div className="Skill2 large-12 medium-12 small-12 columns" id="Skill_2" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', boxSizing: 'border-box', border: '3px solid red', width: 'inherit', height: 'max-content' }}>
                        <div className="Skillname large-12 medium-12 small-12 columns" style={{ textAlign: 'left', width: 'inherit' }}>
                    ...
                    {/* Skill 3 */}
                    <div className="Skill3 large-12 medium-12 small-12 columns" id="Skill_3" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', boxSizing: 'border-box', border: '3px solid red', width: 'inherit', height: 'max-content' }}>
                        <div className="Skillname large-12 medium-12 small-12 columns" style={{ textAlign: 'left', width: 'inherit' }}>
                            Kĩ năng quản lí ( Quản lí thời gian, lập kế hoạch, tổ chức công việc )
                        </div>
                        <div className="slider-container large-12 medium-12 small-12 columns" style={{ display: 'flex', justifyContent: 'center', alignItems: 'flex-start', flexDirection: 'column', width: 'inherit' }}>
                    ...
                    {/* Skill 4 */}
                    <div className="Skill4 large-12 medium-12 small-12 columns" id="Skill_4" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', boxSizing: 'border-box', border: '3px solid red', width: 'inherit', height: 'max-content' }}>
                        <div className="Skillname large-12 medium-12 small-12 columns" style={{ textAlign: 'left', width: 'inherit' }}>
